...
@interface ZCSearchTVViewController ()<UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate>
...
@implementation ZCSearchTVViewController
...
- (NSMutableArray *)dataSource {
    ...
    if (_dataSource == nil) {
        ...
        NSDictionary *dict = [NSMutableDictionary dictionaryWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"TV_Channel" ofType:@"plist"]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *reuseID = @"tv_cell";
    ...
    if (tableView == self.tableView) {
        ...
        cell.detailTextLabel.text = [dict[@"tvid"] stringValue];
